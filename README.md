...
4. **Weighted Total Score**:
   - The total score is a weighted combination of the three metrics:  
     ...
     ```
   - Here, the values **0.4**, **0.4**, and **0.2** represent the weights assigned to the **`Planarity Score`**, **`Flatness Score`**, and **`Density Score`**, respectively.
   - These weights determine the relative importance of each metric in the final scoring calculation.
